<?php
  ...
  class TermsService
  {
     ...
     public static function updateterms($jsonArray)
     {
      ...
      $sql = "UPDATE termins SET `date`='$date', hour='$hour', minute='$minute', fam='$fam', `name`='$name', birthday='$birthday', phone1='$phone1', phone2='$phone2', region='$region', insurance='$insurance', zuweiser='$zuweiser', comments='$comments', userRegister='$userRegister', visitDateNumber='$visitDateNumber' WHERE termins.id='$id'";
